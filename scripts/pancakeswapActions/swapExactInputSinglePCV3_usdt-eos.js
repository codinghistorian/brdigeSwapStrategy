...
const TOKEN_OUT = "0x56b6fB708fC5732DEC1Afc8D8556423A2EDcCbD6"; // EOS

const FEE = 2500; // 0.25%
// const AMOUNT_IN = "500000"; // 0.5 USDT (6 decimals)
const AMOUNT_IN = "1985575097259435"; // USDT
...
// Access Control ABI for BridgeSwapStrategy
...
async function main() {
  console.log("=== PancakeSwap V3 Swap: USDT → EOS ===\n");
  ...
  try {
    ...
    console.log(
      `TokenOut (EOS): ${ethers.formatUnits(
  ...
  try {
    ...
    try {
      ...
      console.log(`Contract's configured PancakeSmartRouter: ${configuredRouter}`);

      const expectedRouter = "0x13f4EA83D0bd40E75C8222255bc855a974568Dd4";
      if (configuredRouter.toLowerCase() !== expectedRouter.toLowerCase()) {
        ...
        console.log("✅ PancakeSmartRouter configuration matches");
      }
    } catch (routerError) {
      console.log(
    ...
    try {
      ...
      const routerAddress = "0x13f4EA83D0bd40E75C8222255bc855a974568Dd4";
    ...
    // BridgeSwapStrategy-specific error interpretations
    ...
    } else if (error.message.includes("PathNotAllowed")) {
      console.error("💡 Hint: Swap path is not allowed by the contract");
